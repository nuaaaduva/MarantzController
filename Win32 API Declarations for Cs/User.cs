...
namespace Win32
{
    ...
    public delegate void TimerProc(HWND hWnd, uint nMsg, uint nTimerId, uint dwTime);
    public delegate bool DialogProc(HWND hwndDlg, uint uMsg, IntPtr wParam, IntPtr lParam);
    public delegate bool DrawStateProc(HDC hdc, IntPtr lData, IntPtr wData, int cx, int cy);
    public delegate bool EnumFunc(HWND childHwnd, LPARAM lParam);
    public delegate bool PropEnumProc(HWND hwnd, string lpszString, HANDLE hData);
    public delegate bool EnumWindowStationProc(string lpszWindowStation, LPARAM lParam);
    public delegate bool OutputFunc(HDC hDC, LPARAM lParam, int nCount);
    public delegate void SendAsyncProc(HWND hwnd, uint uMsg, int dwData, int IResult);
	...
	public static class User
	{
        ...
        [DllImport("user32")] public static extern int CreateDialogIndirectParam(HANDLE hInstance, ref DLGTEMPLATE lpTemplate, HWND hwndParent, DialogProc lpDialogFunc, int dwInitParam);
        ...
        [DllImport("user32")] public static extern int CreateDialogParam(HANDLE hInstance, string lpName, HWND hwndParent, DialogProc lpDialogFunc, int lParamInit);
        ...
        [DllImport("user32")] public static extern int DialogBoxIndirectParam(HANDLE hInstance, DLGTEMPLATE hDialogTemplate, HWND hwndParent, DialogProc lpDialogFunc, int dwInitParam);
        ...
        [DllImport("user32")] public static extern int DrawState(HWND hdc, HANDLE hBrush, DrawStateProc lpDrawStateProc, int lParam, int wParam, int n1, int n2, int n3, int n4, int un);
        ...
        [DllImport("user32")] public static extern int EnumChildWindows(HWND hwndParent, EnumFunc lpEnumFunc, int lParam);
        ...
        [DllImport("user32")] public static extern int EnumProps(HWND hwnd, PropEnumProc lpEnumFunc);
        [DllImport("user32")] public static extern int EnumPropsEx(HWND hwnd, ref int lpEnumFunc, int lParam);
        [DllImport("user32")] public static extern int EnumPropsEx(HWND hwnd, PropEnumProc lpEnumFunc, int lParam);
        [DllImport("user32")] public static extern int EnumThreadWindows(int dwThreadId, ref int lpfn, int lParam);
        [DllImport("user32")] public static extern int EnumThreadWindows(int dwThreadId, EnumFunc lpfn, int lParam);
		[DllImport("user32")] public static extern int EnumWindowStations(int lpEnumFunc, int lParam);
        [DllImport("user32")] public static extern int EnumWindowStations(EnumWindowStationProc lpEnumFunc, int lParam);
        [DllImport("user32")] public static extern int EnumWindows(int lpEnumFunc, int lParam);
        [DllImport("user32")] public static extern int EnumWindows(EnumFunc lpEnumFunc, int lParam);
        ...
        [DllImport("user32")] public static extern int GrayString(HWND hdc, HANDLE hBrush, OutputFunc lpOutputFunc, ref int lpData, int nCount, int X, int Y, int nWidth, int nHeight);
        ...
        [DllImport("user32")] public static extern int SendMessageCallback(HWND hwnd, int msg, int wParam, int lParam, SendAsyncProc lpResultCallBack, int dwData);
        ...
        [DllImport("user32")] public static extern int SetTimer(HWND hwnd, int nIDEvent, int uElapse, TimerProc lpTimerFunc);
        ...
        [DllImport("user32")] public static extern int SetWindowsHook(int nFilterType, HookProc pfnFilterProc);
        [DllImport("user32")] public static extern int SetWindowsHookEx(int idHook, ref int lpfn, HANDLE hmod, int dwThreadId);
        [DllImport("user32")] public static extern int SetWindowsHookEx(int idHook, HookProc lpfn, HANDLE hmod, int dwThreadId);
        ...
        [DllImport("user32")] public static extern int UnhookWindowsHook(int nCode, HookProc pfnFilterProc);
